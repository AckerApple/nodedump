 ...
 * @returns {string}
 */
function doRowHeader(dataType, label, expand){
  return format(ROWHEADER, dataType, doHeaderStyle(dataType, expand), label);
}
      ...
      default:
        ...
        if(circPath.length > 0){
          ...
          if(numTotalKeys === 0)
            ...
            var dataLabel = dataType=='Array' ? dataType+' '+obj.length : dataType
            data = doRowHeader(dataType, dataLabel, expand) + data;
          }
        }
      break;
    }
